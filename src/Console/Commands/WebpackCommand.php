...
class WebpackCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'pacman:webpack {module_name} {--directory=}';
     ...
     * @var string
     */
    protected $description = 'Create a new webpack mix js for specific module';
